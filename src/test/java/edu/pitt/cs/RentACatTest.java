...
public class RentACatTest {
	...
	public void testCatAvailableFalseNumCats0() {
		...
		assertFalse("Did not return false when no cats available", ret);
	}
	...
	public void testCatAvailableTrueNumCats3() {
		...
		boolean ret = r.catAvailable(2);
		assertTrue("Did not return true when cat 2 is available", ret);
	}
	...
	public void testCatAvailableFalseNumCats3() {
		...
		boolean ret = r.catAvailable(2);
		assertFalse("Did not return false when cat 2 is unavailable", ret);
	}
	...
	public void testCatExistsFalseNumCats0() {
		...
		assertFalse("Did not return false when no cats exist", ret);
	}
	...
	public void testCatExistsTrueNumCats3() {
		...
		boolean ret = r.catExists(2);
		assertTrue("Did not return true when cats exist", ret);
	}
	...
	public void testReturnCatFailureNumCats0() {
		...
		assertFalse("Did not return false when no cats", ret);
	}
	...
	public void testReturnCatNumCats3() {
		...
		assertTrue("Did not return true when rented cat was returned", ret);
